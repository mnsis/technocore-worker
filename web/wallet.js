...
// web/wallet-source.js
var EVM_DERIVATION_PATH = "m/44'/60'/0'/0/0";
function checksumAddress(hexAddress) {
...
function generateWallet() {
  ...
  try {
    return walletFromMnemonic(entropyToMnemonic(entropy, wordlist));
  } finally {
    entropy.fill(0);
  }
}
function mnemonicEntropyBits(mnemonic) {
